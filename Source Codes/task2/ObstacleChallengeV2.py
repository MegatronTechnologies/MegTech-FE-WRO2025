import cv2
import sys
sys.path.append('/home/MegTech/autonomous_car/')
...
# ------------------------------------------------------------{ initialization of variables }-------------------------------------------------------------------------
    ...
    write(1500) # send initial value to servo for calibration
    ...
    key2_pin = 25  # Changed to your GPIO25
...
# ------------------------------------------------------------{ contour detection of walls, pillars, and orange and blue lines }-------------------------------------------------------------------------
        ...
        #get an image from RealSense camera
