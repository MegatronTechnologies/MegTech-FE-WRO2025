...
from masks import rMagenta, rBlack, lotType
    ...
    # Setup GPIO for servo and motor
GPIO.setmode(GPIO.BCM)
GPIO.setup(18, GPIO.OUT)  # Servo PWM on GPIO18
servo_pwm = GPIO.PWM(18, 50)  # 50Hz for MG996R servo
servo_pwm.start(0)

# L298N for DC motor
GPIO.setup(17, GPIO.OUT)  # IN1
GPIO.setup(27, GPIO.OUT)  # IN2
GPIO.setup(22, GPIO.OUT)  # ENA PWM
motor_pwm = GPIO.PWM(22, 100)  # 1kHz PWM for motor
motor_pwm.start(45)
...
def write(value):
    ...
    if 180 > value > 0:
        ...
        duty = (value / 18) + 2.5  # Map to 2.5-12.5% duty cycle for MG996R
        servo_pwm.ChangeDutyCycle(duty)
    
    elif 2000 > value > 1000:
        speed_duty = abs(value - 1500) / 5
        motor_pwm.ChangeDutyCycle(speed_duty)
